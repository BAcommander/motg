...
<head>
    ...
    <title>Leaders - Master of the Galaxy</title>
    <link rel="stylesheet" href="assets/css/main.css">
</head>
<body>
    <div class="container">
        <header class="game-header">
            <h1>Empire Leaders</h1>
        ...
        <div style="background: var(--secondary-bg); border: 1px solid var(--border-color); border-radius: 8px; padding: 40px; text-align: center;">
            <h2>Empire Leaders</h2>
            <p>Leader management features coming soon!</p>
            <p><em>This will include hiring admirals, scientists, spies, and colony governors with special abilities.</em></p>
        </div>
    </div>
</body>
</html>